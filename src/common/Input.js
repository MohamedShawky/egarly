...
class Input extends PureComponent {
  ...
  render() {
    ...
    const labelStyle = [
      {
        position: "absolute",
        top: responsiveHeight((height - pv) / 2),
        ...
        transform: [
          {
            translateY: this._animatedIsFocused.interpolate({
              inputRange: [0, 1],
              outputRange: [0, -responsiveHeight(height / 2 - 2)]
            })
          },
          {
    ...
    return (
      ...
      >
        {this.props.hint && (
          <AppText
            bold
            color={this.props.hintColor || "white"}
            marginVertical={5}
          >
            {this.props.hint}
          </AppText>
        ...
        {!noValidation && this.props.errorInput && (
          <InputError
            error={

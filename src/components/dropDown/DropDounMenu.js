...
export default class MultiSelect extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      selector: props.selector ? props.selector : false,
      searchTerm: ''
    };
  ...
  _toggleItem = item => {
    ...
    if (single) {
      ...
      onSelectedItemsChange([item[uniqueKey]], item);
    } else {
    ...
    return (
      ...
      >
        {selector ? (
          ...
          >
            {this.props.noPlaceholder && !this.props.search ? null : 
            ...
            >
              <TextInput
                ...
                placeholder={searchInputPlaceholderText}ß
            ...
            <View style={{alignSelf:'stretch',  justifyContent:'center'}}><TouchableOpacity
                  onPress={() => this._submitSelection()}
                  style={[
                   this.props.showSubmitStyle,
                  ]}
                >
                 {this.props.showSubmitContent}
                </TouchableOpacity>
                </View>}
            ...
            >
              ...
              {/* {!single && !hideSubmitButton && !this.props.showSubmit&& (
                <TouchableOpacity
                  onPress={() => this._submitSelection()}
                  style={[
                    styles.button,

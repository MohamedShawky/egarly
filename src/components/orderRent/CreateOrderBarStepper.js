...
const OrderStep = ({ text, active, Done }) => (
  <AppView flex centerX stretch height={8}>
    <AppView stretch center>
      ...
      />
      {/* <AppView circleRadius={8} borderColor={Done ? "done" : active ? "primary" : "#9F9F9F"} borderWidth={0.5} center>
        
        <AppView
          circleRadius={3}
          backgroundColor={Done ? "done" : active ? "primary" : "#9F9F9F"}
        />
      </AppView> */}
    </AppView>
    <AppView flex center wrap>
      <AppText

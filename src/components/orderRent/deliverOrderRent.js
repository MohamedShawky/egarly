...
import { WaitToPay, PaymentInfo } from "./Payment";

export default props => (
  <AppView stretch {...props.rest}>
    <PaymentInfo {...props.order} />
    {/* <PaymentDetail /> */}
  </AppView>
);
  ...
  >
    ...
    >
      <AppView row stretch>
        ...
        <AppText marginHorizontal={3}>{I18n.t("agree-pay")}</AppText>
      </AppView>
    </AppView>
  </AppView>
);
